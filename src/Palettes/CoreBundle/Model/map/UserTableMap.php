...
class UserTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Palettes.CoreBundle.Model.map.UserTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Palettes\\CoreBundle\\Model\\User');
        ...
        $this->addColumn('role', 'Role', 'VARCHAR', false, 32, null);
        // validators
    } // initialize()
