...
use Palettes\CoreBundle\Model\map\UserTableMap;
...
abstract class BaseUserPeer
{
    ...
    const OM_CLASS = 'Palettes\\CoreBundle\\Model\\User';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Palettes\\CoreBundle\\Model\\map\\UserTableMap';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Username', 'Email', 'Password', 'Salt', 'Role', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'username', 'email', 'password', 'salt', 'role', ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID, UserPeer::USERNAME, UserPeer::EMAIL, UserPeer::PASSWORD, UserPeer::SALT, UserPeer::ROLE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USERNAME', 'EMAIL', 'PASSWORD', 'SALT', 'ROLE', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'username', 'email', 'password', 'salt', 'role', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Username' => 1, 'Email' => 2, 'Password' => 3, 'Salt' => 4, 'Role' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'username' => 1, 'email' => 2, 'password' => 3, 'salt' => 4, 'role' => 5, ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID => 0, UserPeer::USERNAME => 1, UserPeer::EMAIL => 2, UserPeer::PASSWORD => 3, UserPeer::SALT => 4, UserPeer::ROLE => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USERNAME' => 1, 'EMAIL' => 2, 'PASSWORD' => 3, 'SALT' => 4, 'ROLE' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'username' => 1, 'email' => 2, 'password' => 3, 'salt' => 4, 'role' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseUserPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Palettes\CoreBundle\Model\map\UserTableMap());
      }
    }
