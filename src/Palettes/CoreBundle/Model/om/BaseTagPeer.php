...
use Palettes\CoreBundle\Model\map\TagTableMap;
...
abstract class BaseTagPeer
{
    ...
    const OM_CLASS = 'Palettes\\CoreBundle\\Model\\Tag';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Palettes\\CoreBundle\\Model\\map\\TagTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseTagPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Palettes\CoreBundle\Model\map\TagTableMap());
      }
    }
