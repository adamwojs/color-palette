 ...
 *
 * @method TagQuery leftJoinPaletteTag($relationAlias = null) Adds a LEFT JOIN clause to the query using the PaletteTag relation
 * @method TagQuery rightJoinPaletteTag($relationAlias = null) Adds a RIGHT JOIN clause to the query using the PaletteTag relation
 * @method TagQuery innerJoinPaletteTag($relationAlias = null) Adds a INNER JOIN clause to the query using the PaletteTag relation
 *
...
abstract class BaseTagQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'Palettes\\CoreBundle\\Model\\Tag';
        }
    ...
    public function filterByPaletteTag($paletteTag, $comparison = null)
    {
        if ($paletteTag instanceof PaletteTag) {
            return $this
                ->addUsingAlias(TagPeer::ID, $paletteTag->getTagId(), $comparison);
